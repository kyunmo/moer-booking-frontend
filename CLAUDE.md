...
> **상세 spec:** `docs/superpowers/specs/2026-05-12-public-redesign-design.md`
> **킥오프 로그:** `docs/history/2026-05-12-ui-ux-redesign-kickoff.md`

- **범위**: 공개 페이지 20개 (마케팅 8 + 법적 3 + booking 9). 관리자 제외
- **디자인 방향**: Editorial Soft 베이스 + Korean Tech 가독성 (따뜻한 화이트 + 세리프 헤드라인 + Pretendard 본문)
- **컴포넌트 전략**: 공개=Headless(자체 컴포넌트) / admin=Vuetify 유지
- **IA 변경**: support → faq 흡수, forgot+reset 단일 플로우, `/login`에서 사장님/고객 분기, 비회원 reserve 허용
- **브랜드**: YEMO · "예약은 예모로" · 워드마크
- **실행 전략**: Hybrid Track — Day 1~2 토큰 → Day 3~5 랜딩 → Phase 1 마케팅 → Phase 2 인증 → Phase 3 Booking → Phase 4 약관
- **백업**: 이전 시도 → `backup/old-redesign-202603-05` 브랜치
- **진행 단계**: ✅ Phase 0 Foundation (2026-05-13). ✅ Phase 1 Marketing (2026-05-13). ✅ Phase 2 Legal (2026-05-13) — `/privacy`, `/terms`, `/refund-policy` + legal layout + LegalHeader + LegalToc(sticky·IntersectionObserver). 다음 → Phase 3 Booking 입구 (`layouts/booking.vue` + `/booking/`, `/booking/[slug]/`, `/booking/profile`). 완료 기록: `docs/history/2026-05-13-phase{0,1,2}-complete.md`

## 진행사항 (2026-03-04) — 리셋 전 작업 (참고용)
...
- `docs/history/` — 결정/진행 로그 (날짜순)
- `docs/superpowers/specs/` — 디자인 스펙 (브레인스토밍 산출물)
- `docs/vue-version/` — Vuetify 버전 참조
