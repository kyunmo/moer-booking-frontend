...
const faqs = [
  ...
  // 3. 요금 & 결제
  { category: 'pricing', q: '요금제는 어떻게 되나요?', a: '심플한 2가지 플랜이 있습니다.\n\n무료 플랜: 0원\n• 월 30건 예약\n• 스태프 1명\n• 기본 예약/고객 관리\n\n유료 플랜: 20,000원/월 (VAT 별도)\n• 월 예약 무제한\n• 스태프 5명\n• 카카오톡 자동 알림\n• 통계 및 리포트\n• 전체 기능 사용\n• 연간 결제 시 200,000원/년 (2개월 무료)\n\n자세한 내용: /pricing' },
  { category: 'pricing', q: 'VAT는 별도인가요?', a: '네, 유료 플랜 20,000원/월은 VAT 별도 금액입니다.\nVAT 포함 시 22,000원/월, 연간 결제 시 220,000원/년입니다.\n\n사업자 고객:\n• 세금계산서 발행 가능\n• 이메일로 자동 발송\n• 부가세 공제 가능' },
