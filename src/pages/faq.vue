...
meta:
  layout: public
  public: true
  title: 자주 묻는 질문 - 모에르(MOER)
  description: 모에르(MOER) 예약 시스템에 대해 자주 묻는 질문과 답변을 확인하세요.
...
const faqs = [
  // 1. 시작하기
  { category: 'start', q: '모에르(MOER)는 어떤 서비스인가요?', a: '모에르(MOER)는 소상공인을 위한 예약 관리 시스템입니다.\n\n주요 기능:\n• 24시간 자동 예약 접수\n• 카카오톡 자동 알림\n• 고객 이력 자동 관리\n• 실시간 통계 대시보드\n\n미용실, 필라테스, 스터디카페 등 예약이 필요한 모든 업종에서 사용 가능합니다.' },
