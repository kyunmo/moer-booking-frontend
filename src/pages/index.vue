...
// 문제 제기 카드
// [일러스트 추천] 각 카드에 어울리는 일러스트:
//   1. 끊임없이 울리는 전화 → "전화벨이 울리는 스마트폰" 또는 "바쁜 매장에서 전화 받는 직원"
//   2. 수첩에 빼곡한 예약 → "빼곡한 수첩/달력" 또는 "겹치는 스케줄 메모지"
//   3. 예약하고 안 오는 고객 → "빈 의자/빈 매장" 또는 "시계를 보며 기다리는 직원"
//   4. 지난번에 뭐 했더라? → "물음표가 떠있는 사람" 또는 "기억을 떠올리는 직원"
const problems = [
  {
    icon: 'ri-phone-line',
    color: 'error',
            ...
            <VCard class="h-100 text-center pa-4" variant="tonal">
              <VCardText>
                <VAvatar
                  ...
                  class="mb-4"
                >
                  <VIcon :icon="problem.icon" size="32" />
                </VAvatar>
